...
/// Hesap silmeden önce onay — `true` onay, `false` / `null` iptal.
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                AppTranslations.section('delete_account_dialog', 'title'),
                textAlign: TextAlign.center,
                style: AppTextStyles.chatTitle().copyWith(fontSize: 20),
              ),
              const SizedBox(height: 10),
              Text(
                AppTranslations.section('delete_account_dialog', 'message'),
                textAlign: TextAlign.center,
